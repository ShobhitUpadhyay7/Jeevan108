...
// const blackboxClient = new OpenAI({
//   apiKey: process.env.BLACKBOX_API_KEY || "",
//   baseURL: "https://api.blackbox.ai/v1",
// });

// // Medical keywords to validate if question is medical-related
// const MEDICAL_KEYWORDS = [
//   "medical", "health", "symptom", "disease", "illness", "condition",
//   "doctor", "patient", "treatment", "medicine", "medication", "drug",
//   "diagnosis", "prescription", "therapist", "therapy", "hospital",
//   "clinic", "nurse", "caretaker", "compounder", "healthcare",
//   "pain", "fever", "cough", "headache", "infection", "vaccine",
//   "covid", "covid-19", "coronavirus", "flu", "cold", "allergy",
//   "blood pressure", "diabetes", "heart", "cancer", "tumor",
//   "surgery", "operation", "wound", "injury", "fracture", "bone",
//   "muscle", "joint", "skin", "eye", "ear", "nose", "throat",
//   "mental health", "depression", "anxiety", "stress", "psychology"
// ];

// // Check if question is medical-related
// function isMedicalQuestion(question: string): boolean {
//   const lowerQuestion = question.toLowerCase();
//   return MEDICAL_KEYWORDS.some(keyword => lowerQuestion.includes(keyword));
// }

// // Validate medical question
// function validateMedicalQuestion(question: string): { valid: boolean; message?: string } {
//   if (!question || question.trim().length === 0) {
//     return { valid: false, message: "Please enter a question." };
//   }

//   if (question.trim().length < 10) {
//     return { valid: false, message: "Question is too short. Please provide more details." };
//   }

//   if (!isMedicalQuestion(question)) {
//     return {
//       valid: false,
//       message: "This chatbot only answers medical and healthcare-related questions. Please ask a medical question."
//     };
//   }
...
//     // Validate if it's a medical question
//     const validation = validateMedicalQuestion(message);
//     if (!validation.valid) {
...
//     const completion = await blackboxClient.chat.completions.create({
//       model: "blackboxai/openai/gpt-4",
//       messages: [
//         {
//           role: "system",
//           content: "You are a helpful medical assistant. You provide general medical information and guidance. Always remind users that you are not a substitute for professional medical advice, diagnosis, or treatment. Encourage users to consult qualified healthcare providers for serious medical concerns. Be clear, empathetic, and informative in your responses. Focus on general health information, wellness tips, and educational content."
//         },
//         {
//           role: "user",
//           content: message
...
- Always include a brief disclaimer that you provide general information and are not a substitute for professional medical advice
